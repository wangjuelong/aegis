...
HELPER_DIR="${SCRIPT_DIR}/windows"
REMOTE_SCRIPT_PATH="${SCRIPT_DIR}/windows-runtime-verify.ps1"
BUILD_SCRIPT_PATH="${HELPER_DIR}/build-driver.ps1"
BUILD_MINIFILTER_SCRIPT_PATH="${HELPER_DIR}/build-minifilter.ps1"
INSTALL_SCRIPT_PATH="${HELPER_DIR}/install-driver.ps1"
UNINSTALL_SCRIPT_PATH="${HELPER_DIR}/uninstall-driver.ps1"
AMSI_SCAN_SCRIPT_PATH="${HELPER_DIR}/scan-script-with-amsi.ps1"
SCRIPT_EVENT_QUERY_PATH="${HELPER_DIR}/query-script-events.ps1"
MEMORY_SNAPSHOT_SCRIPT_PATH="${HELPER_DIR}/query-memory-snapshot.ps1"
REGISTRY_EVENT_QUERY_PATH="${HELPER_DIR}/query-registry-events.ps1"
REGISTRY_PROTECTION_SCRIPT_PATH="${HELPER_DIR}/configure-registry-protection.ps1"
FILE_EVENT_QUERY_PATH="${HELPER_DIR}/query-file-events.ps1"
FILE_PROTECTION_SCRIPT_PATH="${HELPER_DIR}/configure-file-protection.ps1"
MINIFILTER_INSTALL_SCRIPT_PATH="${HELPER_DIR}/install-minifilter.ps1"
MINIFILTER_UNINSTALL_SCRIPT_PATH="${HELPER_DIR}/uninstall-minifilter.ps1"
PREEMPTIVE_BLOCK_SCRIPT_PATH="${HELPER_DIR}/configure-preemptive-block.ps1"
