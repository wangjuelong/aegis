...
| O08 | Linux 设备控制链（udev / USBGuard / mount monitor） | todo | 当前仓库还缺 Linux `DeviceControl` provider 与设备控制交付目录 |
| O09 | Linux Runtime SDK / Cloud Connector 多语言交付 | todo | 当前仓库还缺 `Python/Node.js/Go/Java` 参考 SDK 与真实多语言验证链 |
