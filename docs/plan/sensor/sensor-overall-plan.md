...
- Windows 当前完成的是平台代码骨架、provider 注册、事件注入、能力矩阵与测试基线，真实驱动/系统级交付尚未完成。
...
| O02 | Windows 驱动 / ELAM / WFP / Minifilter 真实系统级交付 | todo | 当前仅完成 Windows 平台骨架与测试基线 |
| O03 | Windows 正式硬件根信任、签名与兼容性验证 | todo | 当前未完成正式硬件 trust chain 与驱动签发验证 |
